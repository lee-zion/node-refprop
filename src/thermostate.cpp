...
// 	TPFLSHdll(obj->T,obj->P,&(obj->Z),obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcTD(ThermoState* obj) {
// 	TDFLSHdll(obj->T,obj->D,&(obj->Z),obj->P,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcTH(ThermoState* obj) {
// 	long kr;
// 	THFLSHdll(obj->T,obj->H,&(obj->Z),kr,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcTS(ThermoState* obj) {
// 	long kr;
// 	TSFLSHdll(obj->T,obj->S,&(obj->Z),kr,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcTE(ThermoState* obj) {
// 	long kr;
// 	TEFLSHdll(obj->T,obj->E,&(obj->Z),kr,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcPD(ThermoState* obj) {
// 	PDFLSHdll(obj->P,obj->D,&(obj->Z),obj->T,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcPH(ThermoState* obj) {
// 	PHFLSHdll(obj->P,obj->H,&(obj->Z),obj->T,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }
// void RefpropContext::calcPS(ThermoState* obj) {
// 	PSFLSHdll(obj->P,obj->S,&(obj->Z),obj->T,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcPE(ThermoState* obj) {
// 	PEFLSHdll(obj->P,obj->E,&(obj->Z),obj->T,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcHS(ThermoState* obj) {
// 	HSFLSHdll(obj->H,obj->S,&(obj->Z),obj->T,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcES(ThermoState* obj) {
// 	ESFLSHdll(obj->E,obj->S,&(obj->Z),obj->T,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->H,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcDH(ThermoState* obj) {
// 	DHFLSHdll(obj->D,obj->H,&(obj->Z),obj->T,obj->P,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcDS(ThermoState* obj) {
// 	DSFLSHdll(obj->D,obj->S,&(obj->Z),obj->T,obj->P,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->E,obj->H,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcDE(ThermoState* obj) {
// 	DEFLSHdll(obj->D,obj->E,&(obj->Z),obj->T,obj->P,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->Q,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcTQ(ThermoState* obj) {
// 	long kq;
// 	TQFLSHdll(obj->T,obj->Q,&(obj->Z),kq,obj->P,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->E,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }

// void RefpropContext::calcPQ(ThermoState* obj) {
// 	long kq;
// 	PQFLSHdll(obj->P,obj->Q,&(obj->Z),kq,obj->T,obj->D,obj->DL,obj->DV,&(obj->X),&(obj->Y),obj->E,obj->H,obj->S,obj->CV,obj->CP,obj->W,this->ierr,this->herr,errormessagelength);
// }
...
// 		TRNPRPdll(state->T,state->D,&(state->Z),trns->mu,trns->k,this->ierr,this->herr,errormessagelength);
// 		trns->mu *= 1e-6;
...
// 		TRNPRPdll(state->T,state->DL,&(state->Z),trns->muL,trns->kL,this->ierr,this->herr,errormessagelength);
// 		trns->muL *= 1e-6;
// 		TRNPRPdll(state->T,state->DV,&(state->Z),trns->muV,trns->kV,this->ierr,this->herr,errormessagelength);
// 		trns->muV *= 1e-6;
// 		SURTENdll(state->T,state->DL,state->DV,&(state->Z),&(state->Z),trns->sigma,this->ierr,this->herr,errormessagelength);

// 		CVCPdll(state->T,state->DL,&(state->Z),trns->CVL,trns->CPL);
// 		CVCPdll(state->T,state->DV,&(state->Z),trns->CVV,trns->CPV);
